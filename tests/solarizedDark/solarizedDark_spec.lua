require("plenary.reload").reload_module("rosePine", true)
local rosePine = require("rosePine")
local default = rosePine.config

describe("setup", function()
  it("works with default values", function()
    rosePine.setup()
    assert.are.same(rosePine.config, default)
  end)
  ...
  it("works with old italic values", function()
    ...
    rosePine.setup({ italic = true })
    assert.are.same(rosePine.config, expected)
  end)
  ...
  it("works with config overrides", function()
    ...
    rosePine.setup({ undercurl = false, underline = false })
    assert.are.same(rosePine.config, expected)
  end)
end)
